...
import { getTripById, getTripMembers, deleteTrip } from '../../../lib/TripService';
...
export default function TripOverviewScreen() {
    ...
    if (loading) {
        return (
            <>
                <Stack.Screen options={{ title: "Trip Overview", headerShown: true }} />
        ...
        <>
            ...
            <ScrollView className="flex-1 bg-gray-50">
                ...
                <View className="bg-white px-6 py-6 mb-2">
                    <Text className="text-3xl font-bold text-gray-800 mb-2">{trip.title}</Text>
