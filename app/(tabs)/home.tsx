...
import { prefetchExploreData } from "../../lib/exploreCache";
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    // Warm up explore data in the background so the Explore tab is instant.
    prefetchExploreData();
  }, []);
    ...
    <>
      ...
      >
        <View className="px-6 pt-12 pb-6 bg-neutral-background">
          <View className="mb-3">
            <Text className="text-2xl font-bold text-primary-midnightIndigo">
              Your Trips
            </Text>
        ...
        <View className="px-6 py-4">
          {trips.length === 0 ? (
            <View className="bg-neutral-surface rounded-lg p-6 items-center">
              <Text className="text-neutral-textSecondary text-center mb-4">
                No trips yet
              </Text>
              <TouchableOpacity
